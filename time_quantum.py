...
def time_quantum_experiment(processes):

    quantums = [2, 4, 8, 16, 32]

    print("\n" + "="*70)
    print("TIME QUANTUM EXPERIMENT")
    print("="*70)

    for q in quantums:

        print("\n" + "-"*60)
        print(f"RR Quantum = {q}")
        print("-"*60)

        rr = RoundRobinScheduler(quantum=q)
        adrr = ADRRScheduler()
        ai = AI_ADRRScheduler()
...
def main():
    ...
    time_quantum_experiment(processes)
