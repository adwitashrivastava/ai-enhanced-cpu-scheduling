...
def load_processes_from_csv(path):
    ...
    return processes
# -------------------------------
# UNIFORM ARRIVAL DATASET
# -------------------------------
def uniform_arrival_dataset(processes):
...
# -------------------------------
# BURST ARRIVAL DATASET
# -------------------------------
def burst_arrival_dataset(processes):
...
# -------------------------------
# RANDOM ARRIVAL DATASET
# -------------------------------
import random
def random_arrival_dataset(processes):
...
def print_arrival_stats(name, processes):
    ...
    print("Arrival Min:", min(arrivals))
    print("Arrival Max:", max(arrivals))

def arrival_pattern_experiment(base_processes):

    uniform = uniform_arrival_dataset(base_processes)
    burst = burst_arrival_dataset(base_processes)
    random_arr = random_arrival_dataset(base_processes)

    datasets = [
        ("UNIFORM ARRIVAL DATASET", uniform),
        ("BURST ARRIVAL DATASET", burst),
        ("RANDOM ARRIVAL DATASET", random_arr)
    ]

    for name, processes in datasets:

        print_arrival_stats(name, processes)
...
def main():
    ...
    arrival_pattern_experiment(processes)
